...
urlpatterns = [
    ...
    path('product/<int:pID>', views.product_detail_view,
         name="product_detail"),  # view_product_detail
    path('author/<int:auID>', views.author_detail_view,
         name="author_detail"),  # view_author_detail
    ...
    path('account/social/signup/', views.signup_redirect, name='signup_redirect'),
    ...
    path('checkout_detail/<int:iID>',
         views.view_checkout_detail, name='checkout_detail'),
]
